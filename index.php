<?php
echo "Решение задачь в самом тексте PHP файла"; 
...
function apisitecomapprove($barcode3) {
  ...
  $response1 = file_get_contents($filename1, false, $context1);
...
//преобразуем их к числовому виду (itn например)
...
//сгенерировать `barcode` c помощью md5
...
//цикл пока не придет подтверждение от API (api.site.com) броня
...
//barcode в виде md5
$barcode= md5($rand);
//отправка api через функцию предполагаю что так запрос составляется
